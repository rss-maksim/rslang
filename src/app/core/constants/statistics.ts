export const LOCAL_STORAGE_STATS_KEY = 'rslang-short-term-statistics';

export const LINE_CHART_COLORS_1 = {
...
export const LINE_CHART_COLORS_2 = {
  backgroundColor: 'rgba(255,64,129,0.3)',
  borderColor: '#ff4081',
  pointBackgroundColor: 'rgba(255,64,129,1)',
  pointBorderColor: '#fff',
  pointHoverBackgroundColor: '#fff',
  pointHoverBorderColor: 'rgba(255,64,129,0.8)',
};
